...
function BairroDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BairroDashboard.useEffect": ()=>{
            if (!id) return;
            const fetchBairro = {
                "BairroDashboard.useEffect.fetchBairro": async ()=>{
                    try {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("bairros").select("*").eq("id", id).single();
                        if (error) {
            ...
            }["BairroDashboard.useEffect.fetchBairro"];
            fetchBairro();
        }
    }["BairroDashboard.useEffect"], [
        id
...
//# sourceMappingURL=_9312e692._.js.map