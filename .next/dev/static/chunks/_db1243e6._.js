...
"[project]/types/funsau.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/dados-mock-completos.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mockPacientesPM = pacientesMockLista;
const mockProtocolosPM = protocolosMockLista;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/lib/relatorios-engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getDashboardPrincipal() {
    ...
    const protocolosMes = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProtocolosPM"].filter((p)=>{
    ...
    const glosas = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockAuditorias"].filter((a)=>a.status === 'Glosa').length;
    const tempoMedio = 3.5; // dias
    // Policiais aptos vs afastados
    const policiaisAfastados = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].filter((p)=>p.historico_atendimentos.some((h)=>new Date(h.data).getMonth() === mesAtual && !h.apto_para_servico)).length;
    const policiaisAptos = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].length - policiaisAfastados;
    return [
        {
        ...
        },
        {
            ...
            valor: `${policiaisAptos}/${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].length}`,
            tendencia: 'stable',
            variacao: 0,
            icone: 'Shield',
            cor: 'emerald'
...
function getRelatorioByPatente() {
    ...
    return patentes.map((patente)=>{
        const pacientes = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].filter((p)=>p.patente === patente);
        const protocolos = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProtocolosPM"].filter((p)=>p.paciente.patente === patente);
        const valorTotal = protocolos.reduce((sum, p)=>sum + p.valor_total, 0);
        const valorGlosa = protocolos.reduce((sum, p)=>{
            const auditoria = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockAuditorias"].find((a)=>a.protocolo === p.numero_protocolo);
...
function getRelatorioByUnidade() {
    ...
    return unidades.map((unidade)=>{
        const pacientes = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].filter((p)=>p.unidade.toLowerCase().includes(unidade.toLowerCase()) || unidade === 'ROTA' && p.unidade.includes('ROTA') || unidade === 'CPO' && p.unidade.includes('Comando de Operações Especiais'));
        const protocolos = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProtocolosPM"].filter((p)=>pacientes.some((pac)=>pac.id === p.paciente.id));
...
function detectarFraude() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProtocolosPM"].forEach((prot)=>{
...
"[project]/lib/auditoria-engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/validacao-qr.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function validarQRPaciente(dadosQR, dadosDispositivo, capturarFoto = false) {
    ...
    if (agora > validade) {
        ...
        alertas.push('QR CODE EXPIRADO: Carteirinha vencida há ' + Math.floor((agora.getTime() - validade.getTime()) / (1000 * 60 * 60 * 24)) + ' dias');
    }
...
function gerarHashQRPaciente(matricula, dataEmissao) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(input).toString('base64').substring(0, 32);
}
...
"[project]/components/simulador-protocolo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dados-mock.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auditoria-engine.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validacao$2d$qr$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/validacao-qr.ts [app-client] (ecmascript)");
;
...
function SimuladorProtocolo() {
    _s();
    const [simulando, setSimulando] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [passos, setPassos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [protocolo, setProtocolo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const iniciarSimulacao = async ()=>{
        ...
        const paciente = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"][Math.floor(Math.random() * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].length)];
        // Gera protocolo
        const novoProtocolo = {
        ...
        for(let i = 0; i < passosSimulacao.length; i++){
            ...
            switch(i){
                ...
                case 1:
                    // Simula auditoria
                    const auditoria = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].executarAuditoriaPrevia({
                        ...novoProtocolo,
                        paciente,
                    ...
                    break;
                case 2:
                    const validacao = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validacao$2d$qr$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ValidacaoQREngine"].validarQRPaciente({
                        ...
                        qr_code_hash: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validacao$2d$qr$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ValidacaoQREngine"].gerarHashQRPaciente(paciente.matricula, paciente.created_at),
                        data_validade_qr: new Date(Date.now() + __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validacao$2d$qr$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ValidacaoQREngine"].TEMPO_EXPIRACAO_QR).toISOString()
                    }, {
                    ...
                    detalhes = validacao.proxima_acao === 'liberar' ? 'Validação biométrica aprovada' : 'Requer verificação adicional';
                    break;
                case 3:
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            simulando && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mb-6",
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                        className: `text-xs mt-1 ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PATENTES_PM"].find((p)=>p.nome === protocolo.paciente.patente)?.cor || 'bg-gray-100'}`,
            ...
            passos.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            passo.tempo_estimado && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            passo.detalhes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(SimuladorProtocolo, "6eCU6Sr8aqqczwaugkfN1JesoR0=");
_c = SimuladorProtocolo;
var _c;
__turbopack_context__.k.register(_c, "SimuladorProtocolo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/funsau/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/badge.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$funsau$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/types/funsau.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dados-mock-completos.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$relatorios$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/relatorios-engine.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auditoria-engine.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$simulador$2d$protocolo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/simulador-protocolo.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function FunsauPage() {
    _s();
    const [cpfBusca, setCpfBusca] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const pacientesEmAndamento = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pacientesMockLista"].slice(0, 3);
    // Protocolos recentes
    const protocolosRecentes = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["protocolosMockLista"].slice(0, 5);
    const buscarPaciente = ()=>{
        if (!cpfBusca) return;
        // Procurar paciente e navegar
        const paciente = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPacientesPM"].find((p)=>p.cpf === cpfBusca);
        if (paciente) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-slate-900",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["statsFunsauPM"].atendimentos_dia
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 152,
                                                        columnNumber: 19
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-slate-900",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["statsFunsauPM"].em_auditoria
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 166,
                                                        columnNumber: 19
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-slate-900",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["statsFunsauPM"].aprovados
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 180,
                                                        columnNumber: 19
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-slate-900",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["statsFunsauPM"].glosados
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 194,
                                                        columnNumber: 19
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-slate-900",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["statsFunsauPM"].valor_processado
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 208,
                                                        columnNumber: 19
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                                ...
                                                                children: "🎬 Simulador de Protocolo"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/funsau/page.tsx",
                                                                lineNumber: 230,
                                                                columnNumber: 21
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$simulador$2d$protocolo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimuladorProtocolo"], {}, void 0, false, {
                                        fileName: "[project]/app/funsau/page.tsx",
                                        lineNumber: 239,
                                        columnNumber: 15
                                    }, this)
                                                            ...
                                                            children: [
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    className: `text-xs px-2 py-0.5 rounded-full ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dados$2d$mock$2d$completos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PATENTES_PM"].find((p)=>p.nome === pac.patente)?.cor || 'bg-gray-100 text-gray-700'}`,
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        pac.alergias && pac.alergias.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "mt-1 flex flex-wrap gap-1 justify-end",
                                                                            children: pac.alergias.map((alergia, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: protocolosRecentes.map((prot)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        prot.valor_glosado > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-3",
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$relatorios$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RelatoriosEngine"].detectarFraude().slice(0, 3).map((alerta, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-3",
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$relatorios$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RelatoriosEngine"].getRelatorioByPatente().slice(0, 4).map((rel, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].regras.length
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 444,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].regras.filter((r)=>r.severidade === 'critica').length
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 448,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].tabelaBrasindice).length
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/funsau/page.tsx",
                                                        lineNumber: 454,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].tabelaBrasindice).reduce((sum, key)=>{
                                                            const proc = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auditoria$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuditoriaEngine"].tabelaBrasindice[key];
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$funsau$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FUNSAU_CATEGORIAS"]).map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: cat.rota,
                                className: "group",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
_s(FunsauPage, "kDN3ZWAQ93DPomBtIIYxkjKA2OE=", false, function() {
    return [
...
_c = FunsauPage;
var _c;
__turbopack_context__.k.register(_c, "FunsauPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_db1243e6._.js.map